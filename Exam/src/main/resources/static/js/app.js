...
function hacerTrampaPreguntaB(){
    setCSRFtoken();
    var data = {}
    var victim = "pepito";
    data['from'] = victim;      // la trampa, lo estoy probando
    data['type'] = 'GAME_OVER'; // mandando este request como pepa
    ...
    $.ajax({
        ...
        url : '/api/game_over',
        success : function(response) {
            alert("You have successfully surrendered, you are "+username + " right?");
            alert("The surrendering players name: " + victim);
            leave();
        },
        error : function(e) {
            console.log('ERROR: ', e);
